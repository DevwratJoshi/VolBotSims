...
void createRobots(String input)
{
  ...
  print("Large robots = " + large_robots + "  Small robots = " + small_robots);

}
/*
void correct_robot_distributon(String quantity, int small_robots, int actual_small)
{
  ...
  // quantity_to_reduce is the quantity of the robot which we have too many of. For example, if we have too many small robots, then quantity_to_reduce would be float small (here 20)
  ...
  int quantity_to_reduce = 0;
  if(small_robots > actual_small)
  {
