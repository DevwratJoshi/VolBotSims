...
float R_initial = mid + mid*2*3; // The distance of influence is expressed in module lengths (ML).  The initial value is 2.5 ML. 
...
float R_max = mid + mid*2*3; // The final distance of influence is 4 module lengths.
