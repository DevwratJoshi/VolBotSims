...
void setSimulationConditions()
{
   ...
   if(amplitude > maxAmp)
     ...
     if(!exitFlag)
    {
       ...
       outputx = createWriter(folder_begin + "/"  + "sections_max" + str(horizontalDivisions)  + "/"+ "X/" + "bottom" +  str(int(b_line_bottom)));
       outputy = createWriter(folder_begin + "/"  + "sections_max" + str(horizontalDivisions)  + "/"+ "Y/" + "bottom" +  str(int(b_line_bottom)));  
